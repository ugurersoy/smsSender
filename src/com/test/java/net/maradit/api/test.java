package com.test.java.net.maradit.api;

import java.util.ArrayList;
import java.util.List;

import com.java.net.maradit.api.Envelope;
import com.java.net.maradit.api.Maradit;
import com.java.net.maradit.api.ReportDetail;
import com.java.net.maradit.api.ReportResponse;
import com.java.net.maradit.api.Response;
import com.java.net.maradit.api.Settings;
import com.java.net.maradit.api.SettingsResponse;
