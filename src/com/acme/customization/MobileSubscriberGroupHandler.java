...
public class MobileSubscriberGroupHandler extends JLbsCustomXUIEventListener {

	public MobileSubscriberGroupHandler() {
	...
	public void onGridLookup(JLbsXUIGridEvent event)
	{
		...
		event.getContainer().openChild("MobileSubscribersBrowser.lfrm", info, true,
